...
namespace VotingSystem.Test
{
    public class CounterTests
    {
        ...
        [InlineData(2, 8, 25)]
        public void GetStatistics_ShowPercentageUptoTwoDecimalsBasedOnTotalCount(int count, int total, double expected)
        {
        ...
        public void ResovleExcess_AddsExcessToHighestCounter(double initial, double expected, double lowest)
        {
        ...
        public void ResovleExcess_AddsExcessToLowestCounterWhereMoreThanOneHighestCounter(double initial, double expected, double highest)
        {
        ...
        [Fact]
        public void ResovleExcess_DoesntAddExcessIfTotalPercentIs100()
        {
